...
See also the utility's help option. `vns-blockchain-stats --help`

From the command line run:

`$ vns-blockchain-stats`
...
- `vns-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `vns-blockchain-stats | save-to-database.sh`
